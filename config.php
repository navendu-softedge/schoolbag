...
//echo $_SERVER['SERVER_NAME']; 
	//">" is there so it it will not return 0 only true or false
		$vusername = "bf7bf719f27716";              //your username for you local system 
		$pwd ="c56f3bdf"; 
		$host = "eu-cdbr-azure-north-a.cloudapp.net";   
		$dbname = "as_69b6130010cfc8f";          
	  //$websiteURL="http://www.schoolbag.ie";
        $websiteURL="http://schoolbag.azurewebsites.net/"; 
...
//	echo"J";
	...
	$websiteURL="http://localhost/schoolbag";
	$siteAdministrator="damien@onsight.ie";
